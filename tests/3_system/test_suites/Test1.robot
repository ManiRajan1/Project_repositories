*** Settings ***
Library    ${Framework_path}/CANLibrary.py
Library    ${Framework_path}/ECULibrary.py
Library    ${Virtual_env_path}/OperatingSystem.py
Library    SeleniumLibrary
Test Setup    Connect To CAN    ${CAN_channel}

*** Variables ***
${Framework_path}    ../../../configs/robot/libraries
${Virtual_env_path}   ../../../.venv/lib/python3.12/site-packages/robot/libraries/
${CAN_channel}    vcan0   
${vin_value}    9043
${browser}    Chrome
